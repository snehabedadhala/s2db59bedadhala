...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Whiskey App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Whiskey App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Whiskey App Login', user : req.user }); 
}); 
